...
public class RNBranchConfig {
    ...
    public boolean getDebugMode() {
        ...
        try {
            if (!mConfiguration.has("debugMode"))
                return false;
    ...
    public String getBranchKey() {
        ...
        try {
            if (!mConfiguration.has("branchKey"))
                return null;
    ...
    public boolean getUseTestInstance() {
        ...
        try {
            if (!mConfiguration.has("useTestInstance"))
                return false;
